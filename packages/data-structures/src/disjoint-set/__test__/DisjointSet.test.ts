...
describe('DisjointSet', () => {
  ...
  it('should do basic manipulations on disjoint set', () => {
    ...
    expect(disjointSet.find('A')?.root?.key).toBe('A')
    expect(disjointSet.find('B')).toBeNull()
    disjointSet.makeSet('B')
    expect(disjointSet.find('A')?.root?.key).toBe('A')
    expect(disjointSet.find('B')?.root?.key).toBe('B')
    ...
    disjointSet.union('A', 'B')
    expect(disjointSet.find('A')?.root?.key).toBe('A')
    expect(disjointSet.find('B')?.root?.key).toBe('A')
    ...
    expect(disjointSet.find('A')?.root?.key).toBe('A')
    expect(disjointSet.find('B')?.root?.key).toBe('A')
    expect(disjointSet.find('C')?.root?.key).toBe('A')
    ...
    expect(disjointSet.find('I')?.root?.key).toBe('E')
  ...
  it('should union smaller set with bigger one making bigger one to be new root', () => {
    ...
    expect(disjointSet.find('A')?.root?.key).toBe('B')
  })
  ...
  it('should do basic manipulations on disjoint set with custom key extractor', () => {
    ...
    expect(disjointSet.find(itemA)?.key).toBe('A')
    expect(disjointSet.find(itemB)).toBeNull()

    disjointSet.makeSet(itemB)

    expect(disjointSet.find(itemA)?.root?.key).toBe('A')
    expect(disjointSet.find(itemB)?.root?.key).toBe('B')
    ...
    expect(disjointSet.find(itemA)?.root?.key).toBe('A')
    expect(disjointSet.find(itemB)?.root?.key).toBe('A')
    ...
    expect(disjointSet.find(itemA)?.root?.key).toBe('A')
    expect(disjointSet.find(itemB)?.root?.key).toBe('A')
    expect(disjointSet.find(itemC)?.root?.key).toBe('A')
